    ...
    <div className="space-y-8 pr-4">
      ...
      <div>
        ...
        <button 
          ...
          className="w-full py-6 border-2 border-dashed border-amber-400 rounded-3xl hover:bg-amber-50 text-amber-600 font-medium text-lg flex items-center justify-center gap-3"
        >
              ...
              {AMENITY_OPTIONS.map(amenity => (
                <button
                  ...
                  className={`p-4 rounded-2xl border transition-all ${
                    selectedAmenities.includes(amenity) ? 'bg-amber-50 border-amber-500' : 'hover:bg-gray-50'
                  }`}
                >
                  {amenity}
                </button>
